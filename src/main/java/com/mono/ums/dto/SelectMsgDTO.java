...
public class SelectMsgDTO implements Serializable{

	private static final long serialVersionUID = 4663819791691236563L;
	...
	public String toString() {
		return "SelectMsgDTO [msgid=" + msgid + ", sendtype=" + sendtype + ", schtype=" + schtype + ", subject=" + subject + ", msgcnt=" + msgcnt
